...
export const Header: React.FC<HeaderProps> = ({ property1 = "default", className = "", ...props }) => {
  ...
  return (
    <div className={`header-property-1-default ${className} ${variantsClassName}`} {...props}>
      {/* Search Section */}
      <div className="frame-119">
        <div className="frame-17">
          <div className="frame-16">
            <MagnifyingGlassIcon className="solar-magnifer-outline" aria-label="Search icon" />
